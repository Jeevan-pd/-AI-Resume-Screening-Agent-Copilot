...
Contains application constants, scoring weights, API defaults, paths, and visual theme settings.
"""
...
# Common Technical & Soft Skill Taxonomy for Robust Keyword Extraction
