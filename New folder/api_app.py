...
100% self-contained & offline-capable without external API keys.
"""
...
app = FastAPI(
    ...
    description="Production-grade API for automated candidate resume screening, NLP semantic matching, candidate ranking, and interview kit generation.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
